...
const VOICE_PRESETS = new Set(['andrea_natural', 'gaby_warm', 'sofia_calm', 'alejandro_natural']);
...
function normalizeBusinessProfile(raw = {}, defaults = {}) {
  ...
  const voicePreset = cleanText(raw.voicePreset, 40) || 'andrea_natural';
  ...
  if (!VOICE_PRESETS.has(voicePreset)) throw new ControlError(400, 'invalid_voice_preset');
