...
export async function startClinicConfiguration(
  ...
  try {
    ...
    const requestedIntegrations = [
      'autivex_crm',
      ...(['google_calendar', 'calendly'].includes(profile.schedulingProvider)
