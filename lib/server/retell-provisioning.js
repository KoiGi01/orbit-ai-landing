...
export const RETELL_VOICE_PRESETS = Object.freeze({
  andrea_natural: { voiceId: 'retell-Andrea', label: 'Andrea · Natural y profesional' },
  gaby_warm: { voiceId: 'retell-Gaby', label: 'Gaby · Joven y cálida' },
  sofia_calm: { voiceId: 'cartesia-Sofia', label: 'Sofía · Serena y formal', emotion: 'calm' },
  alejandro_natural: { voiceId: 'retell-Alejandro', label: 'Alejandro · Natural y profesional' },
});

export function voicePreset(value) {
  return RETELL_VOICE_PRESETS[value] || RETELL_VOICE_PRESETS.andrea_natural;
}
